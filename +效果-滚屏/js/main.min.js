 ...
 */,t.exports=function(t,n){if(!i.canUseDOM||n&&!("addEventListener"in document))return!1;var e="on"+t,o=e in document;if(!o){var u=document.createElement("div");u.setAttribute(e,"return;"),o="function"==typeof u[e]}return!o&&r&&"wheel"===t&&(o=document.implementation.hasFeature("Events.wheel","3.0")),o}},function(t,n,e){"use strict";var r=!("undefined"==typeof window||!window.document||!window.document.createElement),i={canUseDOM:r,canUseWorkers:"undefined"!=typeof Worker,canUseEventListeners:r&&!(!window.addEventListener&&!window.attachEvent),canUseViewport:r&&!!window.screen,isInWorker:!r};t.exports=i},function(t,n,e){"use strict";e.r(n);var r=e(124),i=e.n(r);function o(t,n){for(var e=0;e<n.length;e++){var r=n[e];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(t,r.key,r)}}var u="js-fullscreen-wrap",s="js-fullscreen-section",c="js-fullscreen-pager",a="js-fullscreen-pager-pointer",f="js-fullscreen-bg",l=["#0fb4ae","#7bc8bc","#868eaf","#ec6867","#f8bb0e"],h=function(){function t(n,e){!function(t,n){if(!(t instanceof n))throw new TypeError("Cannot call a class as a function")}(this,t),this.elmWrap=n.querySelector(".".concat(u)),this.elmSection=n.querySelectorAll(".".concat(s)),this.elmPager=n.querySelector(".".concat(c)),this.elmPagerPointers=n.querySelectorAll(".".concat(a)),this.elmBg=n.querySelector(".".concat(f)),this.currentId=0,this.previousId=0,this.maxId=this.elmSection.length-1,this.isAscend=!0,this.wheelTimer=null,this.isWheeling=!1,this.touchStartY=0,this.isTouchMoved=!1,this.resize(e)}var n,e,r;return n=t,(e=[{key:"start",value:function(){this.on(),document.body.style.overscrollBehavior="none",this.elmSection[this.currentId].classList.add("is-shown"),this.elmSection[this.currentId].classList.add("is-shown-asc"),this.elmPager.classList.add("has-animate"),this.elmPagerPointers[this.currentId].classList.add("is-current"),this.elmBg.classList.add("has-animate"),this.elmBg.style.backgroundColor=l[this.currentId]}},{key:"goToPrev",value:function(){0!==this.currentId&&(this.previousId=this.currentId,this.currentId--,this.isAscend=!1,this.changeSection())}},{key:"goToNext",value:function(){this.currentId>=this.maxId||(this.previousId=this.currentId,this.currentId++,this.isAscend=!0,this.changeSection())}},{key:"goToTarget",value:function(t){this.currentId!==t&&(this.isAscend=t>this.currentId,this.previousId=this.currentId,this.currentId=t,this.changeSection())}},{key:"changeSection",value:function(){for(var t=0;t<this.elmSection.length;t++)this.elmSection[t].classList.remove("is-shown"),this.elmSection[t].classList.remove("is-shown-asc"),this.elmSection[t].classList.remove("is-shown-desc"),this.elmSection[t].classList.remove("is-hidden"),this.elmSection[t].classList.remove("is-hidden-asc"),this.elmSection[t].classList.remove("is-hidden-desc");this.isAscend?(this.elmSection[this.previousId].classList.add("is-hidden"),this.elmSection[this.previousId].classList.add("is-hidden-asc"),this.elmSection[this.currentId].classList.add("is-shown"),this.elmSection[this.currentId].classList.add("is-shown-asc")):(this.elmSection[this.previousId].classList.add("is-hidden"),this.elmSection[this.previousId].classList.add("is-hidden-desc"),this.elmSection[this.currentId].classList.add("is-shown"),this.elmSection[this.currentId].classList.add("is-shown-desc")),this.elmPagerPointers[this.previousId].classList.remove("is-current"),this.elmPagerPointers[this.currentId].classList.add("is-current"),this.elmBg.style.backgroundColor=l[this.currentId]}},{key:"reset",value:function(){this.elmWrap.style.width=0,this.elmWrap.style.height=0}},{key:"resize",value:function(t){this.elmWrap.style.width="".concat(t.x,"px"),this.elmWrap.style.height="".concat(t.y,"px")}},{key:"on",value:function(){var t=this,n=function(n){n.preventDefault();var e=i()(n);if(!1===t.isWheeling){if(Math.abs(e.pixelY)<10)return;e.pixelY<0?t.goToPrev():t.goToNext(),t.isWheeling=!0,t.wheelTimer=setTimeout(function(){t.isWheeling=!1},1e3)}};this.elmWrap.addEventListener("wheel",n,{capture:!0}),this.elmWrap.addEventListener("DOMMouseScroll",n,{capture:!0}),this.elmWrap.addEventListener("touchstart",function(n){t.touchStartY=n.touches[0].clientY},!1),this.elmWrap.addEventListener("touchmove",function(n){if(!0!==t.isTouchMoved){n.preventDefault();var e=t.touchStartY-n.touches[0].clientY;e<-20?t.goToPrev():e>20&&t.goToNext(),Math.abs(e)>20&&(t.isTouchMoved=!0)}},!1),this.elmWrap.addEventListener("touchend",function(n){t.isTouchMoved=!1},!1);for(var e=function(){var n=r;t.elmPagerPointers[r].addEventListener("click",function(e){e.preventDefault(),t.goToTarget(n)})},r=0;r<this.elmPagerPointers.length;r++)e()}}])&&o(n.prototype,e),r&&o(n,r),t}();n.default=function(){var t=new h(document,{x:window.innerWidth,y:window.innerHeight});window.addEventListener("resize",function(){t.reset(),t.resize({x:window.innerWidth,y:window.innerHeight})}),t.start()}}]);